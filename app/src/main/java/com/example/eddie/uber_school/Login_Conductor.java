...
public class Login_Conductor extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login__conductor);
                                ...
                                referencia.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        if (tipo.equals("Conductor")) {
                                            ...
                                            startActivity(new Intent(Login_Conductor.this, Principal.class));
                                            finish();
                                        } else {
    ...
    public void onClick(View view) {
        if(view == btn_sesion){
            ...
            startActivity(new Intent(Login_Conductor.this, Registro.class));
        }
    }
}
